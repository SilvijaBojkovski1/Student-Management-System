...
<div id="add-user" class="hide">
              <div class="main-title" id="au-title" >
                     <p style="margin-top: 20px;">Add Student</p>
              </div>
              ...
              <form action="" method="POST">
                     <div class="form-content-container">
                            ...
                            <div class="add-form-container-2">
                                   ...
                                   <fieldset class="add-user-fieldset fieldset-width">
                                          <legend>Study</legend>
                                          <label >Course</label>
                                          <select name="course">
                                                 <?php 
                                   ...
                                   <input type="submit" name="submit-add-user" value="Submit" class="add-user-bttn" style="margin-right:5px; width:150px; float:right;">
                            </div>
                                  
                     </div>
                     
              </form>     
<button onclick="backToUsers()" class="add-user-bttn" style="margin-left:5px; width:150px; height:30px; font-size:14px;"><- List Users</button>
       </div>
       </div>
